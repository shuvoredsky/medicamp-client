...
const PaymentHistory = () => {
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 max-w-7xl mx-auto bg-teal-50">
      <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-center text-teal-800">
        Payment History
      </h2>
      ...
      <div className="mb-6">
        <input
          ...
          className="w-full md:w-1/2 lg:w-1/3 p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 shadow-sm"
          value={searchTerm}
